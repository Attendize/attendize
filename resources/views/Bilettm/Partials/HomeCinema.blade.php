<section id="kinoteator" class="kinoteator-section">
    <div class="container">
                                                        ...
                                                        <div class="col-12">
                                                            <article class="u-block-hover">
                                                                <div class="g-bg-cover">
                                                                    <img class="d-flex align-items-end" src="assets/assets/img/kinoteator/p1.png">
                                                                </div>
                                                                <img src="assets/assets/img/icons/3d.svg" class="d3-img">
                                                                <div class="u-block-hover__additional--partially-slide-up h-100 text-center g-z-index-1 mt-auto" style="background-image: url(assets/assets/img/kinoteator/overlay/1.svg)">
                                                                    <div class="overlay-details">
                                                                        ...
                                                                        <p class="description">Питер Паркер вместе с друзьями отправляется на летние каникулы в Европу. Однако отдохнуть приятелям вряд ли удастся — Питеру придется согласиться помочь Нику Фьюри раскрыть тайну существ, вызывающих стихийные бедствия и разрушения по всему континенту.</p>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <article class="u-block-hover">
                                                                <div class="g-bg-cover">
                                                                    <img class="d-flex align-items-end" src="assets/assets/img/kinoteator/p2.png">
                                                                </div>
                                                        ...
                                                        <div class="col-6">
                                                            <article class="u-block-hover">
                                                                <div class="g-bg-cover">
                                                                    <img class="d-flex align-items-end" src="assets/assets/img/kinoteator/p4.png">
                                                                </div>
                                                                <img src="assets/assets/img/icons/2d.svg" class="d2-img">
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-6" style="height: 50px;">
                                                            <article class="u-block-hover">
                                                                <div class="g-bg-cover">
                                                                    <img class="d-flex align-items-end" src="assets/assets/img/kinoteator/p3.png">
                                                                </div>
                                                                <img src="assets/assets/img/icons/2d.svg" class="d2-img">
                                                        ...
                                                        <div class="col-6" style="height: 50px;">
                                                            <article class="u-block-hover">
                                                                <div class="g-bg-cover">
                                                                    <img class="d-flex align-items-end" src="assets/assets/img/kinoteator/p5.png">
                                                                </div>
                                                                <img src="assets/assets/img/icons/2d.svg" class="d2-img">
                                                                <div class="u-block-hover__additional--partially-slide-up h-100 text-center g-z-index-1 mt-auto" style="background-image: url(assets/assets/img/kinoteator/overlay/5.svg)">
                                                                    <div class="overlay-details smalll">
                                                                        <h2 class="title">Человек-паук <br> Вдали от дома</h2>
                                                                        <h4 class="date">В кино с 4 июля</h4>
                                                                        <div class="overlay-details-bottom-part">
