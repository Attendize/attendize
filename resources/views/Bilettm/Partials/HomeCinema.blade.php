    ...
    <div class="tab-ozi col-12">
        ...
        <div class="owl-carousel container row" id="kinoteator-tab1" style="padding: 0 !important; margin: 0">
            <div class="slider-slider">
                <div class="row">
                    <div class="col-6">
                        <?php $firstCinema = $cinema->first();?>
                        <article class="u-block-hover">
                            <div class="g-bg-cover">
                                <img class="d-flex align-items-end" src="{{$firstCinema->images->first()->image_path}}">
                            </div>
                            <div class="u-block-hover__additional--partially-slide-up h-100 text-center g-z-index-1 mt-auto" style="background-image: url({{asset('assets/images/overlay/1.svg')}})">
                                <div class="overlay-details">
                                    <h2 class="title">{{$firstCinema->title}}</h2>
                                    <h4 class="date">В кино с {{$firstCinema->start_date->format('d M')}} </h4>
                                    <p class="description">{{$firstCinema->description}}</p>
                                    <div class="overlay-details-bottom-part">
                                        ...
                                        <a href="" class="like">
                                            ...
                                            {{$firstCinema->views_count}} Views</a>
                                        <div class="buy-btn-wrap">
                                            <a href="{{$firstCinema->event_url}}" class="buy-btn">Купить билет</a>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <article class="u-block-hover">
                                    ...
                                    <div class="u-block-hover__additional--partially-slide-up h-100 text-center g-z-index-1 mt-auto" style="background-image: url({{asset('assets/images/overlay/2.svg')}})">
                            ...
                            <div class="col-6">
                                <article class="u-block-hover">
                                    ...
                                    <img src="{{asset('assets/images/icons/2d.svg')}}" class="d2-img">
                                    <div class="u-block-hover__additional--partially-slide-up h-100 text-center g-z-index-1 mt-auto" style="background-image: url({{asset('assets/images/overlay/4.svg')}})">
                                        <div class="overlay-details smalll">
                                            <h2 class="title">Человек-паук <br> Вдали от дома</h2>
                                            <h4 class="date">В кино с 4 июля</h4>
                                            <div class="overlay-details-bottom-part">
                        ...
                        <div class="row">
                            <div class="col-6" style="height: 50px;">
                                <article class="u-block-hover">
                                    ...
                                    <img src="{{asset('assets/images/icons/2d.svg')}}" class="d2-img">
                                    <div class="u-block-hover__additional--partially-slide-up h-100 text-center g-z-index-1 mt-auto" style="background-image: url({{asset('assets/images/overlay/3.svg')}})">
                                        <div class="overlay-details smalll">
                                            <h2 class="title">Человек-паук <br> Вдали от дома</h2>
                                            <h4 class="date">В кино с 4 июля</h4>
                                            <div class="overlay-details-bottom-part">
                            ...
                            <div class="col-6" style="height: 50px;">
                                <article class="u-block-hover">
                                    ...
                                    <img src="{{asset('assets/images/icons/2d.svg')}}" class="d2-img">
                                    <div class="u-block-hover__additional--partially-slide-up h-100 text-center g-z-index-1 mt-auto" style="background-image: url({{asset('assets/images/overlay/5.svg')}})">
                                        <div class="overlay-details smalll">
                                            <h2 class="title">Человек-паук <br> Вдали от дома</h2>
                                            <h4 class="date">В кино с 4 июля</h4>
                                            <div class="overlay-details-bottom-part">
