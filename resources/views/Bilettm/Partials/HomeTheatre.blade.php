    ...
    <div class="container">
        <div class="row teator tab-part">
            ...
            <div class="tab-ozi col-12">
                ...
                <!-- Tab panes -->
                <div id="nav-1-1-default-hor-left-teator" class="tab-content">
                    <div class="tab-pane fade show active" id="nav-1-1-default-hor-left--1-teator" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div id="carousel-09-1" class="js-carousel text-center g-font-size-0 g-mb-20 g-mb-0--sm" data-infinite="true" data-vertical="true" data-arrows-classes="u-arrow-v1 g-absolute-centered--x g-width-35 g-height-35 g-font-size-18 g-color-gray g-bg-white" data-arrow-left-classes="fa fa-angle-up g-top-0" data-arrow-right-classes="fa fa-angle-down g-bottom-0" data-nav-for="#carousel-09-2">
                                        <div class="js-slide">
                                            <a class="d-block">
                                                <img class="img-fluid w-100" src="assets/assets/img/teator/1.png">
                                                <div class="teator-overlay">
                                                    <div class="texts-wrapper" style="color: #ffffff">
                                                        <span class="">12:00, 29.06.2019 y</span>
                                                        <h2>«Lukman Aybolit»</h2>
                                                        <h5>A.S.Puskin adyndaky dowlet rus drama teatry</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                        ...
                                        <div class="js-slide">
                                            <a class="d-block">
                                                <img class="img-fluid w-100" src="assets/assets/img/teator/2.png">
                                                <div class="teator-overlay">
                                                    <div class="texts-wrapper" style="color: #ffffff">
                                                        <span class="">12:00, 29.06.2019 y</span>
                                                        <h2>«Lukman Aybolit»</h2>
                                        ...
                                        <div class="js-slide">
                                            <a class="d-block">
                                                <img class="img-fluid w-100" src="assets/assets/img/teator/3.png">
                                                <div class="teator-overlay">
                                                    <div class="texts-wrapper" style="color: #ffffff">
                                                        <span class="">12:00, 29.06.2019 y</span>
                                                        <h2>«Lukman Aybolit»</h2>
                                        ...
                                        <div class="js-slide">
                                            <a class="d-block">
                                                <img class="img-fluid w-100" src="assets/assets/img/teator/4.png">
                                                <div class="teator-overlay">
                                                    <div class="texts-wrapper" style="color: #ffffff">
                                                        <span class="">12:00, 29.06.2019 y</span>
                                                        <h2>«Lukman Aybolit»</h2>
                                        ...
                                        <div class="js-slide">
                                            <a class="d-block">
                                                <img class="img-fluid w-100" src="assets/assets/img/teator/5.png">
                                                <div class="teator-overlay">
                                                    <div class="texts-wrapper" style="color: #ffffff">
                                                        <span class="">12:00, 29.06.2019 y</span>
                                                        <h2>«Lukman Aybolit»</h2>
                                        ...
                                        <div class="js-slide">
                                            <a class="d-block">
                                                <img class="img-fluid w-100" src="assets/assets/img/teator/6.png">
                                                <div class="teator-overlay">
                                                    <div class="texts-wrapper" style="color: #ffffff">
                                                        <span class="">12:00, 29.06.2019 y</span>
                                                        <h2>«Lukman Aybolit»</h2>
