...
@push('inner_content')
    ...
    <section class="movie-items-group firts-child">
        <div class="container" style="padding: 0 !important;">
            <div class="row kinoteator tab-part">
                <div class="tab-header d-flex justify-content-between col-12" style="padding: 0 15px">
                    <h2 class="">Концерты</h2>
                    <div style="height: 5px; margin-left: 5px; position: absolute; bottom: 5px; width: 100px; background-color: rgba(211,61,51,1)"></div>
                </div>
                <div class="tab-ozi col-12" style="padding: 0 15px">
                        ...
                        <div class="kinoteator-tab1-wrapper">
                            <div class="container">
                                <div class="row">
                                    <div class="col-3">
                                        <article class="u-block-hover">
                                            <div class="g-bg-cover">
                                                <img class="d-flex align-items-end" src="{{asset('assets/images/cc.png')}}" style="border-radius: 5px">
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <ul class="item-group-bottom-pagination">
    ...
    <section id="first-add-wrapper" style="margin: 50px 0 100px 0;">
        <div class="container">
