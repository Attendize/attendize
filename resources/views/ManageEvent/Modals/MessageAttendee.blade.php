        ...
        <div class="modal-content">
            <div class="modal-header text-center">
                ...
                <h3 class="modal-title">
                    ...
                    {!! @trans("ManageEvent.message_attendee_title", ["attendee"=>$attendee->full_name])!!}
                </h3>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="custom-checkbox">
                                ...
                                <label for="send_copy">&nbsp;&nbsp;{!! @trans("Message.send_a_copy_to", ["organiser"=>$attendee->event->organiser->email])!!}</label>
                            </div>
                        </div>
                    </div>
                </div>
